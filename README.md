...
| GitHub stars | 447 |
| GitHub forks | 74 |
| Installer/server downloads | 1,608 |
| Download delta | +3 |
| npm downloads, last week | 598 |
| GitHub views, last 14-ish days | unavailable |
| GitHub clones, last 14-ish days | unavailable |

Generated 2026-09-05T07:42:17.743Z. These are public GitHub/npm adoption signals, not active-user or in-app telemetry numbers. [Full report](docs/public-adoption-stats.md).

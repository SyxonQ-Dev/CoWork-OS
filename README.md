...
| GitHub stars | 440 |
| GitHub forks | 72 |
| Installer/server downloads | 1,552 |
| Download delta | +3 |
| npm downloads, last week | 468 |
| GitHub views, last 14-ish days | unavailable |
| GitHub clones, last 14-ish days | unavailable |

Generated 2026-08-28T15:26:02.848Z. These are public GitHub/npm adoption signals, not active-user or in-app telemetry numbers. [Full report](docs/public-adoption-stats.md).

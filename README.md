...
| GitHub stars | 446 |
| GitHub forks | 74 |
| Installer/server downloads | 1,605 |
| Download delta | +1 |
| npm downloads, last week | 598 |
| GitHub views, last 14-ish days | unavailable |
| GitHub clones, last 14-ish days | unavailable |

Generated 2026-09-04T08:01:04.544Z. These are public GitHub/npm adoption signals, not active-user or in-app telemetry numbers. [Full report](docs/public-adoption-stats.md).
